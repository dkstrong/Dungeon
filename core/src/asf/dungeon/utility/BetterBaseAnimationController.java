 ...
 */
public class BetterBaseAnimationController {
        public final static class Transform implements Pool.Poolable {
        ...
        /** The {@link com.badlogic.gdx.graphics.g3d.ModelInstance} on which the animations are being performed. */
        public final BetterModelInstance target;

        /** Construct a new BaseAnimationController.
         * @param target The {@link ModelInstance} on which the animations are being performed. */
        public BetterBaseAnimationController (final BetterModelInstance target) {
                this.target = target;
        }

        /** Begin applying multiple animations to the instance, must followed by one or more calls to {
         * {@link #apply(com.badlogic.gdx.graphics.g3d.model.Animation, float, float)} and finally {{@link #end()}. */
        ...
        protected void end () {
                ...
                for (ObjectMap.Entry<Node, Transform> entry : transforms.entries()) {

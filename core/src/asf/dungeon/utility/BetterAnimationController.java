...
public class BetterAnimationController extends BetterBaseAnimationController {
        ...
        /** Class describing how to play and {@link com.badlogic.gdx.graphics.g3d.model.Animation}. You can read the values within this class to get the progress of the
         ...
         * @param target The {@link com.badlogic.gdx.graphics.g3d.ModelInstance} on which the animations will be performed. */
        public BetterAnimationController (final BetterModelInstance target) {
                super(target);
        }

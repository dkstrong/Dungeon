 ...
 */
public class BetterModelInstance implements RenderableProvider {
        ...
        public BetterModelInstance (final Model model) {
        ...
        public BetterModelInstance (final Model model, final String nodeId, boolean mergeTransform) {
         ...
         * @param nodeId The ID of the root {@link Node} of the {@link Model} for the instance to contain
         * @param mergeTransform True to apply the source node transform to the instance transform, resetting the node transform. */
        public BetterModelInstance (final Model model, final Matrix4 transform, final String nodeId, boolean mergeTransform) {
         ...
         * @param mergeTransform True to apply the source node transform to the instance transform, resetting the node transform. */
        public BetterModelInstance (final Model model, final String nodeId, boolean parentTransform, boolean mergeTransform) {
         ...
         * @param parentTransform True to apply the parent's node transform to the instance (only applicable if recursive is true).
         * @param mergeTransform True to apply the source node transform to the instance transform, resetting the node transform. */
        public BetterModelInstance (final Model model, final Matrix4 transform, final String nodeId, boolean parentTransform,
         ...
         * @param parentTransform True to apply the parent's node transform to the instance (only applicable if recursive is true).
         * @param mergeTransform True to apply the source node transform to the instance transform, resetting the node transform. */
        public BetterModelInstance (final Model model, final String nodeId, boolean recursive, boolean parentTransform,
                              boolean mergeTransform) {
         ...
         * @param parentTransform True to apply the parent's node transform to the instance (only applicable if recursive is true).
         * @param mergeTransform True to apply the source node transform to the instance transform, resetting the node transform. */
        public BetterModelInstance (final Model model, final Matrix4 transform, final String nodeId, boolean recursive,
        ...
        public BetterModelInstance (final Model model, final String... rootNodeIds) {
                this(model, null, rootNodeIds);
        }

        /** Constructs a new ModelInstance with only the specified nodes and materials of the given model. */
        public BetterModelInstance (final Model model, final Matrix4 transform, final String... rootNodeIds) {
                this.model = model;
                this.transform = transform == null ? new Matrix4() : transform;
                if (rootNodeIds == null)
        ...
        /** Constructs a new ModelInstance with only the specified nodes and materials of the given model. */
        public BetterModelInstance (final Model model, final Array<String> rootNodeIds) {
                this(model, null, rootNodeIds);
        }

        /** Constructs a new ModelInstance with only the specified nodes and materials of the given model. */
        public BetterModelInstance (final Model model, final Matrix4 transform, final Array<String> rootNodeIds) {
                this.model = model;
                this.transform = transform == null ? new Matrix4() : transform;
                copyNodes(model.nodes, rootNodeIds);
                copyAnimations(model.animations);
        ...
        public BetterModelInstance (final Model model, Vector3 position) {
                this(model);
                this.transform.setToTranslation(position);
        }

        /** Constructs a new ModelInstance at the specified position. */
        public BetterModelInstance (final Model model, float x, float y, float z) {
                this(model);
                this.transform.setToTranslation(x, y, z);
        }

        /** Constructs a new ModelInstance with the specified transform. */
        public BetterModelInstance (final Model model, Matrix4 transform) {
                this(model, transform, (String[])null);
        }

        /** Constructs a new ModelInstance which is an copy of the specified ModelInstance. */
        public BetterModelInstance (BetterModelInstance copyFrom) {
                this(copyFrom, copyFrom.transform.cpy());
        }

        /** Constructs a new ModelInstance which is an copy of the specified ModelInstance. */
        public BetterModelInstance (BetterModelInstance copyFrom, final Matrix4 transform) {
        ...
        public BetterModelInstance copy () {
                return new BetterModelInstance(this);
        }
...
//                                        keyframe.translation.set(kf.translation);
        ...
        /** Traverses the Node hierarchy and collects {@link com.badlogic.gdx.graphics.g3d.Renderable} instances for every node with a graphical representation.
         * Renderables are obtained from the provided pool. The resulting array can be rendered via a {@link com.badlogic.gdx.graphics.g3d.ModelBatch}.
         *
